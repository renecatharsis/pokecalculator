...
import {
  CatchRateInputDto,
  catchRateInputSchema,
} from "@/dto/catchRateInputDto";
...
import {
  statusConditionList,
  StatusConditionListInterface,
} from "@/dataProviders/statusConditionProvider";
import {
  pokeballList,
  PokeballListInterface,
} from "@/dataProviders/pokeballProvider";
import {
  pokemonList,
  PokemonListInterface,
} from "@/dataProviders/pokemonProvider";
...
export default function CatchRate() {
      ...
      : pokemonData
          .filter((pokemon) => {
            return pokemon.display
              .toLowerCase()
              .includes(pokemonQuery.toLowerCase());
          })
          .slice(0, MAX_RESULTS);
  ...
  function updatedSelectedStatusCondition(
  ...
  async function onSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    if (!validatedData.success) {
      ...
      setValidationErrors(
        [...validationErrors, ...newErrors].filter(
  ...
  return (
    <div className="min-h-screen md:w-3/5">
      <div className="flex flex-wrap md:flex-nowrap md:space-x-10">
        <div className="md:basis-3/4 md:border-b md:border-t border-gray-200 bg-white shadow-sm sm:rounded-lg sm:border md:p-5">
          <form onSubmit={onSubmit} autoComplete="off">
            <div className="pb-8">
              <h2 className="text-base font-semibold leading-7 text-gray-900">
                Check your approximate catch rate.
              </h2>
              <p className="mt-1 text-sm leading-6 text-gray-600">
                This works primarily for the main line games, some edge cases
                excluded.
                <br />
              ...
              <div className="mt-6 grid grid-cols-1 gap-x-4 gap-y-4 sm:grid-cols-6">
                    ...
                    >
                      ...
                      <div className="relative mt-2">
                        <Combobox.Input
                          ...
                          displayValue={(pokemon: PokemonListInterface) =>
                            pokemon.display
                          }
                          name="pokemon"
                        />
                ...
                <div className="sm:col-span-2">
                  <Listbox
                    ...
                    onChange={updatedSelectedGeneration}
                  >
                    {({ open }) => (
                      <>
                        ...
                        <div className="relative mt-2">
                          ...
                          >
                            <Listbox.Options className="absolute z-10 mt-1 max-h-56 w-full overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm">
                              {generations.map(
                                (generation: GenerationListInterface) => (
                                  <Listbox.Option
                                    key={generation.id}
                                    className={({ active }) =>
                                      mergeClassList(
                ...
                <div className="sm:col-span-2">
                  <Listbox
                    ...
                    onChange={updatedSelectedPokeball}
                  >
                    {({ open }) => (
                      <>
                        <Listbox.Label className="block text-sm font-medium leading-6 text-gray-900">
                        ...
                        <div className="relative mt-2">
                          ...
                          >
                            <Listbox.Options className="absolute z-10 mt-1 max-h-56 w-full overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm">
                              {pokeballs.map(
                                (pokeball: PokeballListInterface) => (
                                  <Listbox.Option
                                    key={pokeball.id}
                                    className={({ active }) =>
                                      mergeClassList(
                ...
                <div className="sm:col-span-2">
                  <Listbox
                    ...
                    onChange={updatedSelectedStatusCondition}
                  >
                    {({ open }) => (
                      <>
                        <Listbox.Label className="block text-sm font-medium leading-6 text-gray-900">
                ...
                <div className="sm:col-span-2 sm:col-start-1">
                  ...
                  <div className="mt-2">
                    <input
                      ...
                      name="hpCurrent"
                      id="hpCurrent"
                      placeholder="Use orange/red bar if unknown"
                ...
                <p
                  className={
                    ...
                    !hasBackendError && validationErrors.length === 0
                      ? "hidden"
                      : "")
                  }
                >
                  <span className={!hasBackendError ? "hidden" : ""}>
                    Something went wrong :-/
                  </span>
                  <br />
                  <span
                    className={validationErrors.length === 0 ? "hidden" : ""}
                  >
          ...
          <div className="pt-6 pb-6 border-t border-b md:border-b-0 border-gray-900/10 ">
            <p className="text-base font-semibold leading-7 text-gray-900">
              Catch rate probability: <span>{catchRate}%</span>
            </p>
          </div>
        </div>

        <div className="md:basis-1/3 pt-5 md:p-5 md:border-b md:border-t border-gray-200 bg-white shadow-sm sm:rounded-lg sm:border">
          <h2 className="text-base font-semibold leading-7 text-gray-900">
            Good to know:
          </h2>
          <ul className="mt-2">
