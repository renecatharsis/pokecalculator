        ...
        <div className="relative flex items-center justify-between">
          ...
          <div className="flex w-full items-center justify-between px-4">
            <div>
              ...
              <nav
                className={`absolute right-4 z-50 top-full w-full max-w-[250px] rounded-lg bg-white py-5 px-6 shadow lg:static lg:block lg:w-full lg:max-w-full lg:bg-transparent lg:py-0 lg:shadow-none ${
                  !open && "hidden"
                } `}
              >
